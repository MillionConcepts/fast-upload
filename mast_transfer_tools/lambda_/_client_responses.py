"""
TODO: all contents of this module are (at least in part) placeholders, and in
 particular the functions that take an exception as an argument -- they need
 to actually format it
"""
...
def err_response(func: Callable) -> Callable:
    def dump_err_response(*args, **kwargs):
...
@err_response
def lambda_main_execution_error(_ex: Exception):
    return "lambda execution", "unclassified lambda execution failure"


def pipeline_exec_success_msg():
